...
class ClientServiceImplTest {
    ...
    class FindClientTests {
        ...
        void shouldGetClientByDni() {
            // Note: service.getClientByDni calls repo.findClientByDni
            when(clientRepository.findClientByDni("12345678A")).thenReturn(Optional.of(clientDto));
    ...
    class CrudTests {
        ...
        void shouldCreateClient() {
            // Service checks if client exists first
        ...
        void shouldThrowExceptionWhenCreatingIfDniNotFound() {
             ...
             // if (client.isEmpty()) { throw new ResourceNotFoundException("Service not found"); }
             // This logic seems weird for create (usually if it EXISTS it should throw, or if it doesn't exist it should create).
             // But I must test what is written.

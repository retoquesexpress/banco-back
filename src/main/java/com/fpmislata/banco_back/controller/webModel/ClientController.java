...
public class ClientController {
    ...
    @GetMapping
    public ResponseEntity<ClientDetailResponse>findAllClients() {
    ...
    public ResponseEntity<ClientDetailResponse> getByDni(@PathVariable String dni) {
        ...
        ClientDetailResponse clientDetailResponse = ClientMapper.getInstance().fromClientDtoToClientDetailResponse(clientDto.orElse(null));
        return new ResponseEntity<>(clientDetailResponse, HttpStatus.OK);
    }
    ...
    public ResponseEntity<ClientDetailResponse> create(@RequestBody ClientInsertRequest clientInsertRequest) {
        ...
        ClientDetailResponse createdClientResponse =
                ClientMapper.getInstance().fromClientDtoToClientDetailResponse(createdClient);
    ...
    public ResponseEntity<ClientDetailResponse> update(@PathVariable String dni,
        ...
        ClientDetailResponse updatedClientResponse =
                ClientMapper.getInstance().fromClientDtoToClientDetailResponse(updatedClient);
